...
public class LMRBaxe extends ItemAxe{

	public LMRBaxe(ToolMaterial material)
	{
		super(material);
		this.setCreativeTab(LMRBcreativeTab.LMRB_TAB);
		//this.setUnlocalizedName("purpleaxe");
		//this.setTextureName(Reference.MOD_ID + ":" + "purpleaxe");
	}
